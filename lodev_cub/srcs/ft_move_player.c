...
void	ft_move_backward(t_cub3D *cub3d, double move_speed)
{
	if (cub3d->array->map_arr
		[(int)(cub3d->player->player_point->posX -
		cub3d->player->player_point->dirX * move_speed)]
		[(int)(cub3d->player->player_point->posY)] == '0')
		cub3d->player->player_point->posX -=
			cub3d->player->player_point->dirX * move_speed;
	if (cub3d->array->map_arr
		[(int)cub3d->player->player_point->posX]
		[(int)(cub3d->player->player_point->posY -
		cub3d->player->player_point->dirY * move_speed)] == '0')
		cub3d->player->player_point->posY -=
			cub3d->player->player_point->dirY * move_speed;
}
...
void	ft_move_right(t_cub3D *cub3d, double root_speed)
{
	...
	cub3d->player->player_point->dirX =
		cub3d->player->player_point->dirX *
		cos(-root_speed) - cub3d->player->player_point->dirY * sin(-root_speed);
