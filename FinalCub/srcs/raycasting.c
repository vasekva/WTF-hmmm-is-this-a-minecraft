...
void	ft_vector_init(t_cub3d *cub3d, int x)
{
	...
	cub3d->dda2d.ray_dir_x = cub3d->player.dir_x + cub3d->move.plane_x * camera_x;
	cub3d->dda2d.ray_dir_y = cub3d->player.dir_y + cub3d->move.plane_y * camera_x;
	cub3d->dda2d.map_x = cub3d->player.pos_x;
	cub3d->dda2d.map_y = cub3d->player.pos_y;
	cub3d->dda2d.delta_dist_x = fabs(1 / cub3d->dda2d.ray_dir_x);
	cub3d->dda2d.delta_dist_y = fabs(1 / cub3d->dda2d.ray_dir_y);
}
...
void	ft_init_steps_dda(t_cub3d *cub3d)
{
	if (cub3d->dda2d.ray_dir_x < 0)
	{
		...
		cub3d->dda2d.side_dist_x = (cub3d->player.pos_x - cub3d->dda2d.map_x) * cub3d->dda2d.delta_dist_x;
	}
	else
	{
		cub3d->dda2d.step_x = 1;
		cub3d->dda2d.side_dist_x = (cub3d->dda2d.map_x + 1.0 - cub3d->player.pos_x) * cub3d->dda2d.delta_dist_x;
	}
	if (cub3d->dda2d.ray_dir_y < 0)
	{
		cub3d->dda2d.step_y = -1;
		cub3d->dda2d.side_dist_y = (cub3d->player.pos_y - cub3d->dda2d.map_y) * cub3d->dda2d.delta_dist_y;
	}
	else
	{
		cub3d->dda2d.step_y = 1;
		cub3d->dda2d.side_dist_y = (cub3d->dda2d.map_y + 1.0 - cub3d->player.pos_y) * cub3d->dda2d.delta_dist_y;
	}
}
...
//	cub3d->wall_hit = 0;
	while (hit == 0)
	{
		if (cub3d->dda2d.side_dist_x < cub3d->dda2d.side_dist_y)
		{
			cub3d->dda2d.side_dist_x = cub3d->dda2d.side_dist_x + cub3d->dda2d.delta_dist_x;
		...
		else if (cub3d->dda2d.side_dist_x >= cub3d->dda2d.side_dist_y)
		{
			cub3d->dda2d.side_dist_y = cub3d->dda2d.side_dist_y + cub3d->dda2d.delta_dist_y;
