...
void	ft_vector_init(t_cub3d *cub3d, int x)
{
	...
	cub3d->dda2d.delta_dy = fabs(1 / cub3d->dda2d.raydir_y);
}

void	ft_init_steps_dda(t_cub3d *cub3d)
{
	if (cub3d->dda2d.raydir_x < 0)
	{
		cub3d->dda2d.step_x = -1;
		cub3d->dda2d.side_dx = (cub3d->player.pos_x - cub3d->dda2d.map_x) * cub3d->dda2d.delta_dx;
	}
	else
	{
		cub3d->dda2d.step_x = 1;
		cub3d->dda2d.side_dx = (cub3d->dda2d.map_x + 1.0 - cub3d->player.pos_x) * cub3d->dda2d.delta_dx;
	}
	if (cub3d->dda2d.raydir_y < 0)
	{
		cub3d->dda2d.step_y = -1;
		cub3d->dda2d.side_dy = (cub3d->player.pos_y - cub3d->dda2d.map_y) * cub3d->dda2d.delta_dy;
	}
	else
	{
		cub3d->dda2d.step_y = 1;
		cub3d->dda2d.side_dy = (cub3d->dda2d.map_y + 1.0 - cub3d->player.pos_y) * cub3d->dda2d.delta_dy;
	}
}
...
void 	ft_calc_distance(t_cub3d *cub3d)
{
	if (cub3d->dda3d.side == 0 || cub3d->dda3d.side == 1)
		cub3d->dda3d.wall_dist
			= (cub3d->dda2d.map_x - cub3d->player.pos_x
				+ (1 - cub3d->dda2d.step_x) / 2) / cub3d->dda2d.raydir_x;
	else if (cub3d->dda3d.side == 2 || cub3d->dda3d.side == 3)
		cub3d->dda3d.wall_dist
			= (cub3d->dda2d.map_y - cub3d->player.pos_y
				+ (1 - cub3d->dda2d.step_y) / 2) / cub3d->dda2d.raydir_y;
