...
void	ft_texturing_wall(t_cub3d *cub3d, int x, int i)
{
	...
	if ((cub3d->dda3d.side == 0 || cub3d->dda3d.side == 1) && cub3d->dda2d.ray_dir_x > 0)
		coord_x = cub3d->texture[i].width - coord_x - 1;
	if ((cub3d->dda3d.side == 2 || cub3d->dda3d.side == 3) && cub3d->dda2d.ray_dir_y < 0)
		coord_x = cub3d->texture[i].width - coord_x - 1;
	coord_x = abs(coord_x);
...
void 	ft_draw_walls(t_cub3d *cub3d, int x)
{
	...
	if (cub3d->dda3d.side == 0 || cub3d->dda3d.side == 1)
		cub3d->wall_x = cub3d->player.pos_y + cub3d->dda3d.wall_dist * cub3d->dda2d.ray_dir_y;
	else if (cub3d->dda3d.side == 2 || cub3d->dda3d.side == 3)
		cub3d->wall_x = cub3d->player.pos_x + cub3d->dda3d.wall_dist * cub3d->dda2d.ray_dir_x;
