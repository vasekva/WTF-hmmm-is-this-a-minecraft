...
void	ft_texturing_wall(t_cub3d *cub3d, int x, int i)
{
	...
	if ((cub3d->dda3d.side == 0 || cub3d->dda3d.side == 1) && cub3d->dda2d.raydir_x > 0)
		coord_x = cub3d->tex[i].width - coord_x - 1;
	if ((cub3d->dda3d.side == 2 || cub3d->dda3d.side == 3) && cub3d->dda2d.raydir_y < 0)
		coord_x = cub3d->tex[i].width - coord_x - 1;
	coord_x = abs(coord_x);
	...
	while (y < cub3d->dda3d.draw_end)
	{
		...
		coord_y
			= coord_y * cub3d->tex[i].height / cub3d->dda3d.line_h / 256;
...
void 	ft_draw_walls(t_cub3d *cub3d, int x)
{
	...
	if (cub3d->dda3d.side == 0 || cub3d->dda3d.side == 1)
		cub3d->wall_x = cub3d->player.pos_y + cub3d->dda3d.wall_dist * cub3d->dda2d.raydir_y;
	else if (cub3d->dda3d.side == 2 || cub3d->dda3d.side == 3)
		cub3d->wall_x = cub3d->player.pos_x + cub3d->dda3d.wall_dist * cub3d->dda2d.raydir_x;
