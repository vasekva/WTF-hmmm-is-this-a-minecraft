...
void	ft_def_spr_pos(t_cub3d *cub3d, int i)
{
	...
	cub3d->spr.sp_x = cub3d->c_spr[cub3d->spr.sp_order[i]].x - cub3d->pos_x;
	cub3d->spr.sp_y = cub3d->c_spr[cub3d->spr.sp_order[i]].y - cub3d->pos_y;
	cub3d->spr.inv_det = 1.0 / (plane_x * dir_y - cub3d->plane_y * dir_x);
	cub3d->spr.trans_x
		= cub3d->spr.inv_det
		* (dir_y * cub3d->spr.sp_x - cub3d->dir_x * cub3d->spr.sp_y);
	cub3d->spr.trans_y
		= cub3d->spr.inv_det
...
{
	cub3d->spr.sp_h = abs((int)(cub3d->res_y / cub3d->spr.trans_y));
	cub3d->spr.sp_w = abs((int)(cub3d->res_y / cub3d->spr.trans_y));
	cub3d->spr.draw_starty = -cub3d->spr.sp_h / 2 + cub3d->res_y / 2;
	if (cub3d->spr.draw_starty < 0)
		cub3d->spr.draw_starty = 0;
	cub3d->spr.draw_endy = cub3d->spr.sp_h / 2 + cub3d->res_y / 2;
	if (cub3d->spr.draw_endy >= cub3d->res_y)
		cub3d->spr.draw_endy = cub3d->res_y - 1;
	...
	if (cub3d->spr.draw_endx >= cub3d->res_x)
		cub3d->spr.draw_endx = cub3d->res_x - 1;
}
...
void 	ft_spr_draw(t_cub3d *cub3d, int x, int i)
{
	...
	{
		d = y * 256 - (cub3d->res_y - cub3d->spr.sp_h) * 128;
...
void	ft_spr_init(t_cub3d *cub3d)
{
	...
	while (i < cub3d->spr.nb_sprite)
	{
		...
		while (x < cub3d->spr.draw_endx && x < cub3d->res_x)
		{
